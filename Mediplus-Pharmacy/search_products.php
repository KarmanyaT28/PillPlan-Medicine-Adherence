...
?>
    ...
    <div class="container-fluid">
        <h4><a style="color: white" href="dashboard.php">Home</a>/<a style="color: lightsteelblue" href="products.php">General Purpose medicines</a> </h4>
    </div>
    <div id="mainbody">
                ...
                <div class="col-lg-10">
                    <div class="row">
                        ...
                        if(isset($_POST['search'])){
                            $prod=$_POST['prod'];
                        $res=mysqli_query($conn,"select * from products where med_name like '%$prod%' or company like '%$prod%'");
                                    ...
                                    <form method="post" action="cart.php?action=add&id=<?php echo $row["id"]; ?>">
                                        <div class="product">
                                            <div class="card-image">
                                                <img src="medicine_images/<?php echo $row['image_name']; ?>" class="img-responsive">
                                            </div>
                                            <hr>
                                            <div class="card-body">
